var FileUploadWithPreview = function () {
    ...
    var A, e = (function (A) {
        var e = function (A) {
            var e, t = Object.prototype,
                ...
                B = i.asyncIterator || "@@asyncIterator",
                E = i.toStringTag || "@@toStringTag";

            function r(A, e, t, g) {
                var i = e && e.prototype instanceof c ? e : c,
                    n = Object.create(i.prototype),
                    B = new k(g || []);
                return n._invoke = function (A, e, t) {
                    var g = C;
                    return function (i, n) {
            ...
            var m = Object.getPrototypeOf,
                f = m && m(m(J([])));
            f && f !== t && g.call(f, n) && (h = f);
            var d = u.prototype = c.prototype = Object.create(h);
                        ...
                        return new Promise(function (e, n) {
                            ! function e(t, i, n, B) {
                                ...
                                if ("throw" !== E.type) {
                                    var r = E.arg,
                                        C = r.value;
                                    return C && "object" == typeof C && g.call(C, "__await") ? Promise.resolve(C.__await).then(function (A) {
                                        e("next", A, n, B)
                                    }, function (A) {
                                        e("throw", A, n, B)
            ...
            function S(A, t) {
                ...
                var i = o(g, A.iterator, t.arg);
                if ("throw" === i.type) return t.method = "throw", t.arg = i.arg, t.delegate = null, s;
                var n = i.arg;
                return n ? n.done ? (t[A.resultName] = n.value, t.next = A.nextLoc, "return" !== t.method && (t.method = "next", t.arg = e), t.delegate = null, s) : n : (t.method = "throw", t.arg = new TypeError("iterator result is not an object"), t.delegate = null, s)
            }
                ...
                if (A) {
                    ...
                    if (!isNaN(A.length)) {
                        var i = -1,
                            B = function t() {
                                for (; ++i < A.length;)
                                    if (g.call(A, i)) return t.value = A[i], t.done = !1, t;
            ...
            return l.prototype = d.constructor = u, u.constructor = l, u[E] = l.displayName = "GeneratorFunction", A.isGeneratorFunction = function (A) {
                var e = "function" == typeof A && A.constructor;
                return !!e && (e === l || "GeneratorFunction" === (e.displayName || e.name))
            }, A.mark = function (A) {
                return Object.setPrototypeOf ? Object.setPrototypeOf(A, u) : (A.__proto__ = u, E in A || (A[E] = "GeneratorFunction")), A.prototype = Object.create(d), A
            }, A.awrap = function (A) {
                return {
                    __await: A
                }
                ...
                return this
            }, A.AsyncIterator = v, A.async = function (e, t, g, i) {
                var n = new v(r(e, t, g, i));
                return A.isGeneratorFunction(t) ? n : n.next().then(function (A) {
                    return A.done ? A.value : n.next()
                })
            }, p(d), d[E] = "Generator", d[n] = function () {
                return this
            }, d.toString = function () {
                ...
                dispatchException: function (A) {
                    ...
                    function i(g, i) {
                        return E.type = "throw", E.arg = A, t.next = g, i && (t.method = "next", t.arg = e), !!i
                    }
                    for (var n = this.tryEntries.length - 1; n >= 0; --n) {
                        var B = this.tryEntries[n],
                            E = B.completion;
                        if ("root" === B.tryLoc) return i("end");
                        if (B.tryLoc <= this.prev) {
                            var r = g.call(B, "catchLoc"),
                                o = g.call(B, "finallyLoc");
                            if (r && o) {
                                if (this.prev < B.catchLoc) return i(B.catchLoc, !0);
                                if (this.prev < B.finallyLoc) return i(B.finallyLoc)
                            } else if (r) {
                                if (this.prev < B.catchLoc) return i(B.catchLoc, !0)
                            } else {
                ...
                abrupt: function (A, e) {
                    ...
                    return B.type = A, B.arg = e, n ? (this.method = "next", this.next = n.finallyLoc, s) : this.complete(B)
                },
    ...
    function t(A, e, t, g, i, n, B) {
        ...
        E.done ? e(r) : Promise.resolve(r).then(g, i)
    }
    var g = function (A) {
        return function () {
            var e = this,
    ...
    return Element.prototype.matches || (Element.prototype.matches = Element.prototype.matchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.oMatchesSelector || Element.prototype.webkitMatchesSelector || function (A) {
            ...
            value: function (A) {
                ...
                for (var g = arguments[1], i = 0; i < t;) {
                    var n = e[i];
                    if (A.call(g, n, i, e)) return i;
                    i++
                }
                return -1
            },
        ...
        function () {
            function A(e, t) {
                if (i(this, A), !e) throw new Error("No uploadId found. You must initialize file-upload-with-preview with a unique uploadId.");
                if (this.uploadId = e, this.options = t || {}, this.options.showDeleteButtonOnImages = !this.options.hasOwnProperty("showDeleteButtonOnImages") || this.options.showDeleteButtonOnImages, this.options.text = this.options.hasOwnProperty("text") ? this.options.text : {
            ...
            return B(A, [{
                ...
                value: function (A) {
                    if (0 !== A.length) {
                        ...
                        var i = new CustomEvent("fileUploadWithPreview:imagesAdded", {
                            detail: {
                            ...
                            return e.wrap(function (e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 2:
                                        ...
                                        return r = void 0, o = void 0, e.prev = 5, e.next = 8, fetch(A[E], {
                                            mode: "cors"
                                        });
                                    case 8:
                                    ...
                                    case 11:
                                        ...
                                        break;
                                    case 14:
                                        return e.prev = 14, e.t0 = e.catch(5), n(e.t0), e.abrupt("continue", 21);
                                    case 18:
                                        (C = new Blob([o], {
                                            type: o.type
                                        })).name = A[E].split("/").pop(), B.push(C);
                                    case 21:
                                        E++, e.next = 2;
                                        break;
                                    case 24:
